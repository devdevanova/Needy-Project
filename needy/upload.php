...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO `room` ( `r_id`,`o_id`, `image`,  `cost`, `location`, `description`, `contact`,`name`) 
...
<head>
    ...
    <title>Upload Items to Item Finder</title>
</head>
<body>
    <header>
        <div class="branding">
    ...
    <div class="outer">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="shadow login-form">
            ...
            <textarea name="description" class="text-box" id="address" cols="30" rows="5" placeholder="Description (Facilities)" ></textarea>
